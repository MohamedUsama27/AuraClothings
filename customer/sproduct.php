...
if(isset($_POST['add_to_cart'])){
    ...
    $select_cart = mysqli_query($con, "SELECT * FROM `cart` WHERE name = '$product_name' AND size = '$product_size'");

 
    if(mysqli_num_rows($select_cart) > 0){
       $message[] = 'Product Already Added to Cart';
    }else{
       $insert_product = mysqli_query($con, "INSERT INTO `cart`(`image1`, `name`, `price`, `quantity`, `size`) VALUES('$product_image', '$product_name', '$product_price', '$product_quantity', '$product_size')");
...
<?php
    ...
    <section id="prodetails" class="section-p1">
        ...
        <div class="single-pro-img">
            <img src="../uploads/<?php echo $fetch_product['image1']; ?>" width="100%" id="MainImg" alt="">

            <div class="small-img-group">
                <div class="small-img-col">
                    <img src="../uploads/<?php echo $fetch_product['image1']; ?>" width="100%" class="small-img" alt="">
                </div>

                <div class="small-img-col">
                    <img src="../uploads/<?php echo $fetch_product['image2']; ?>" width="100%" class="small-img" alt="">
                </div>

                <div class="small-img-col">
                    <img src="../uploads/<?php echo $fetch_product['image3']; ?>" width="100%" class="small-img" alt="">
                </div>

                <div class="small-img-col">
                    <img src="../uploads/<?php echo $fetch_product['image4']; ?>" width="100%" class="small-img" alt="">
                </div>
            </div>
        ...
        <form action="" method="post">             
            <div class="single-pro-details">   
                <h6>Home /  <?php echo $fetch_product['category']; ?> </h6>
                <h4><?php echo $fetch_product['name']; ?></h4>
                <h2>Rs. <?php echo number_format($fetch_product['price'],); ?></h2>
